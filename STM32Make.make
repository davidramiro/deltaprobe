...
-ILib/u8g2 \
-Itinyusb \
-Itinyusb/class/audio \
-Itinyusb/class/bth \
-Itinyusb/class/cdc \
-Itinyusb/class/cdc/serial \
-Itinyusb/class/dfu \
-Itinyusb/class/hid \
-Itinyusb/class/midi \
-Itinyusb/class/msc \
-Itinyusb/class/mtp \
-Itinyusb/class/net \
-Itinyusb/class/usbtmc \
-Itinyusb/class/vendor \
-Itinyusb/class/video \
-Itinyusb/common \
-Itinyusb/device \
-Itinyusb/host \
-Itinyusb/osal \
-Itinyusb/portable/analog/max3421 \
-Itinyusb/portable/chipidea/ci_fs \
-Itinyusb/portable/chipidea/ci_hs \
-Itinyusb/portable/ehci \
-Itinyusb/portable/mentor/musb \
-Itinyusb/portable/microchip/pic32mz \
-Itinyusb/portable/microchip/samx7x \
-Itinyusb/portable/nxp/lpc17_40 \
-Itinyusb/portable/ohci \
-Itinyusb/portable/raspberrypi/rp2040 \
-Itinyusb/portable/renesas/rusb2 \
-Itinyusb/portable/st/stm32_fsdev \
-Itinyusb/portable/sunxi \
-Itinyusb/portable/synopsys/dwc2 \
-Itinyusb/portable/valentyusb/eptri \
-Itinyusb/portable/wch \
-Itinyusb/typec
